 ...
 * rightmost leaf
 * 
 * @author Tamara Munzner, Li Zhang, Yunhong Zhou, Sam Hokin
 * @version 2.3
 * @see Tree
 */
public class TreeNode {
     ...
     * Edge lengths are not determined by this number currently; 
     * all edges are stretched to make leaves right aligned, with minimal integral lengths.
     */
