...
/**
 * Abstract implementation of {@link TreeNetworkDataAdapter}, which returns an empty object list adapter
 * for {@link #getNodeEdgeSets(ReadWriteParameterMap)}. Additionally an empty implementation of
 * {@link #writeMetadata(ReadWriteParameterMap, info.bioinfweb.jphyloio.dataadapters.JPhyloIOEventReceiver)} is inherited.
 * <p>
 * Application adapters that do not provide any node/edge sets can be inherited from this class.
 *
...
public abstract class NoSetsTreeNetworkDataAdapter extends EmptyAnnotatedDataAdapter<LabeledIDEvent> implements TreeNetworkDataAdapter {
	 ...
	 * @see info.bioinfweb.jphyloio.dataadapters.TreeNetworkDataAdapter#getNodeEdgeSets(ReadWriteParameterMap)
	 */
