...
/**
 * An object translator between {link {@link Calendar}} and <a href="https://www.w3.org/TR/xmlschema11-2/#date">xsd:date</a>. 
 * 
...
public class DateTranslator extends IllegalArgumentExceptionSimpleValueTranslator<Calendar> {
	...
	public String javaToRepresentation(Object object, WriterStreamDataProvider<?> streamDataProvider)	throws UnsupportedOperationException, ClassCastException {
		return DatatypeConverter.printDate((Calendar)object);  //TODO Should other classes be accepted and converted?
	}
}
